...
specification has not yet been generated, this will generate that as well
as the first step. Supports **all** openapi tools generators + orval
clients.

Arguments:
  passthroughArgs          Additional arguments to pass to the generator.
                           For options for each generator see
                           https://openapi-generator.tech/docs/usage#generate
                           this also accepts Orval additional arguments
                           e.g. --mock etc. See Orval docs as well:
...
Options:
  ...
  --generator <generator>  Generator to use, see all options at:
                           ...
                           or the full list of orval clients. To use orval
                           client, write the generator as this:
                           orval-<orval-client>.
  --debug                  Specify this flag in order to allow logging.
                           Logs will appear in output/_logs. Default: false
