const infrastructure = {
      ...
      },
      {
         ...
         schema: {
            ...
            lock: {
               'value?=false': 'text',
               'tag?=const:bool':
                  'enum|values(["const","const:encoded","const:int","const:decimal","const:bool","const:array","const:epochms","const:obj","const:null","const:expr","const:expr:encoded","input","var","auth","env","setting","col","output","response","trycatch"])',
               'filters[]': 'mvp_filter',
            },
            external: {
               value: 'text',
   ...
   pipe: [
      ...
      },
      {
         ...
         arg: [
            ...
            },
            {
               name: 'from',
               description:
                  'the current character encoding of the supplied text. This is commonly identified by the result of <b>detect_encoding</b>.',
               hint: '',
               default: '',
               type: 'text',
               values: [],
      ...
      },
      {
         ...
         arg: [
            ...
            },
            {
               name: 'escape',
               description:
                  'the escape value - used to allow using the enclosure field within the field',
               hint: '',
               default: '"',
               type: 'text',
               values: [],
         ...
         arg: [
            {
               name: 'encodings',
               description:
                  'optional - leave blank to auto-detect or include a comma seperated list of encodings',
               hint: '',
               default: '',
               type: 'text',
               values: [],
      ...
      },
      {
         ...
         display: 'every',
         description:
            'Higher order filter using a Lambda to determine if all elements evaluate as true in the code block.',
      ...
      },
      {
         ...
         display: 'filter',
         description:
            'Higher order filter using a Lambda to create a new array with all elements that return true in the code block.',
         ...
         arg: [
            {
               name: 'path',
               description:
                  'an optional path within an object - leave blank if just text or numbers',
               hint: '',
               default: '',
               type: 'text',
               values: [],
      ...
      },
      {
         ...
         display: 'find',
         description:
            'Higher order filter using a Lambda to find the first element that evaluates as true in the code block.',
      ...
      },
      {
         ...
         display: 'findIndex',
         description:
            'Higher order filter using a Lambda to find the numerical index of first element that evaluates as true in the code block.',
      ...
      },
      {
         ...
         arg: [
            ...
            },
            {
               name: 'timeDrift',
               description:
                  'optional; if this token is time sensitive, then you can specify an allowable amount of time drift to be more tollerant of clocks not fully synchronized between servers.',
               hint: '',
               default: 0,
               type: 'int',
               values: [],
      ...
      },
      {
         ...
         arg: [
            ...
            },
            {
               name: 'ttl',
               description:
                  'optional; the amount of time in seconds this token is valid - use 0 for no expiration.',
               hint: '',
               default: 0,
               type: 'int',
               values: [],
         ...
         arg: [
            {
               name: 'mask',
               description:
                  'optional - include a list of characters to trim or leave blank to trim whitespace',
               hint: '',
               default: '',
               type: 'text',
               values: [],
      ...
      },
      {
         ...
         display: 'map',
         description:
            'Higher order filter using a Lambda to transform the elements of an array into a different format.',
      ...
      },
      {
         ...
         display: 'reduce',
         description:
            'Higher order filter using a Lambda to convert an array into a single value. (i.e. the sum of all elements)',
      ...
      },
      {
         ...
         display: 'some',
         description:
            'Higher order filter using a Lambda to determine if at least one element evaluates as true in the code block.',
      ...
      },
      {
         ...
         arg: [
            ...
            },
            {
               name: 'type',
               description:
                  'the sorting type - number, text, natural or case-insensitive versions - itext & inatural',
               hint: '',
               default: 'itext',
               type: 'enum',
         ...
         arg: [
            {
               name: 'start',
               description:
                  'the starting position of text extraction. negative values start at the end.',
               hint: '',
               default: '',
               type: 'int',
               values: [],
            },
            {
               name: 'length',
               description:
                  'optional - the length of the extraction. negative values will omit values from the end.',
               hint: '',
               default: '',
               type: 'int',
               values: [],
      ...
      },
      {
         ...
         description:
            'Converts a text expression (now, next friday, Jan 1 2000) to timestamp comparible format.',
         doc: '',
         group: 'transform',
         access: '',
         tags: ['strtotime', 'date.parse', 'datetime.strptime', 'sqlconvert', 'parse'],
   ...
   statement: [
         ...
         context: {
            ...
            'if?={}': {
               'run[]?=[]': {
                  ...
                  '?runtime?=null': {
                     'mode?="disabled"':
                        'enum|values(["disabled","async-shared","async-dedicated"])',
                     'cpu?=""': 'text',
                     'memory?=""': 'text',
                     'max_retry?=0': 'int',
                     'timeout?=0': 'int',
      ...
      },
      {
         ...
         context: {
            'error_type?="standard"':
               'enum|values(["standard","notfound","toomanyrequests","accessdenied","unauthorized","badrequest","inputerror"])',
            'expr?={}': {
               'expression[]?=[]': {
                  'type?="statement"': 'enum|values(["statement","group"])',
                  'or?=false': 'bool',
      ...
      },
      {
         ...
         context: {
            'value?=""': 'text',
            'tag?="const"':
               'enum|values(["const","const:encoded","const:encoded","const:int","const:decimal","const:bool","const:array","const:epochms","const:obj","const:null","const:expr","const:expr:encoded","input","var","auth","env","setting","col","output","response","trycatch"])',
            'filters[]?=[]': {
               'name?=""': 'text',
               'disabled?=false': 'bool',
               'arg[]?=[]': {
